...
void TMVAClassification( TString myMethodList = "" )
{
   ...
   TMVA::DataLoader *dataloader = new TMVA::DataLoader("dataset_trklength");
   ...
   dataloader->AddVariable("dEdx_truncmean_start","dEdx_truncmean_start","",'D');
...
//   dataloader->AddVariable("nhits","nhits","",'D');
   ...
   dataloader->AddVariable("trklength","trklength","",'D');
...
//      gSystem->Exec("wget http://root.cern.ch/files/tmva_class_example.root");
   ...
   TFile *input = TFile::Open("/uboone/app/users/ddevitt/LArSoft_v06_26_01_14_uboonecode_v06_26_01_22/srcs/uboonecode/uboone/CC1pi/PlottingTools/MVA_Trees/MVA_Trees_trklength.root");
...
*/
   dataloader->AddSignalTree(muon, 1./(muon->GetEntries()));
   dataloader->AddSignalTree(pion, 1./(pion->GetEntries()));
   dataloader->AddBackgroundTree(background, 1./(background->GetEntries()));
   ...
   TCut mycuts = "dEdx_truncmean_start < 25 && lnLmipoverp > -20 && lnLmipoverp < 20 && trklength<400";
   TCut mycutb = mycuts; 
