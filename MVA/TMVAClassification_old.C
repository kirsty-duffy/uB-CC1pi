...
// branch, name, unit, type
   ...
   // Nice to plot and verify samples through to the end
   //factory->AddVariable("ccnc", "CC or NC", "", 'I');
   //factory->AddVariable("NuPdg", "Nu PDG at FD", "", 'I');

   if(SelectNuE){
     factory->AddVariable("nshower","Number of Showers","",'F');
     factory->AddVariable("showerdedx","Shower dE/dx","MeV/cm",'F');
     factory->AddVariable("eshower","Shower Energy","GeV",'F');
     factory->AddVariable("frshower","Fraction of Shower Charge","",'F');
     factory->AddVariable("nhitspershw","NHits per Shower Wire","",'F');
     factory->AddVariable("shwlength","Shower Length","wires",'F');
     factory->AddVariable("shwmax","Shower Maximum","",'F');
     factory->AddVariable("shwdisx","Shower vtxx - event vtxx","wires",'F');
     factory->AddVariable("shwdisy","Shower vtxy - event vtxy","wires",'F');
     factory->AddVariable("shwdisz","Shower vtxz - event vtxz","wires",'F');
     factory->AddVariable("shwcosx","","",'F');
     factory->AddVariable("shwcosy","","",'F');
     factory->AddVariable("shwcosz","","",'F');
   }
...
//   factory->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
   ...
   TTree *ncbackground = (TTree*)input->Get("mvaselect/nc");
   TTree *ccbackground = (TTree*)input->Get("mvaselect/cc"); // nue if selecting numucc, otherwise numu
   ...
   factory->AddBackgroundTree( ncbackground, backgroundWeight );
   if(ccbackground->GetEntries()!=0)
     factory->AddBackgroundTree( ccbackground, backgroundWeight );
   ...
   if (Use["TMlpANN"])
      ...
      factory->BookMethod( TMVA::Types::kTMlpANN, "TMlpANN", "!H:!V:NCycles=1000:HiddenLayers=N+1,N:LearningMethod=BFGS:ValidationFraction=0.01"  ); // n_cycles:#nodes:#nodes:...
